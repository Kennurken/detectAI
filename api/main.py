...
# Модель атауын міндетті түрде gemini-2.0-flash-ке ауыстыр (3.0 немесе 2.5 істемейді)
...
def call_gemini(payload):
    try:
        ...
        if "candidates" not in data:
            return {"error": "No candidates found", "raw": data}
